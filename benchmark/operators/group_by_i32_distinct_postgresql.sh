...
\timing on
SELECT 1 FROM Distinct_i32 GROUP BY n10;
SELECT 1 FROM Distinct_i32 GROUP BY n100;
SELECT 1 FROM Distinct_i32 GROUP BY n1000;
SELECT 1 FROM Distinct_i32 GROUP BY n10000;
SELECT 1 FROM Distinct_i32 GROUP BY n100000;
EOF
