...
TEST_CASE("ColumnStore/access", "[core][backend]")
{
    Catalog::Clear();
    auto &C = Catalog::Get();
...
#undef CHECK_CHAR
    ...
    SECTION("booleans exceed pack")
    {
        table.push_back(C.pool("a_b"), Type::Get_Boolean(Type::TY_Vector));
