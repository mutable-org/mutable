...
namespace m
{
    ...
    namespace
    {
        ...
        struct CardinalityEstimatorCRTP : CardinalityEstimator, estimate_join_all_tag::derived_type<Actual>
        {
        };
    ...
    struct M_EXPORT SpnEstimator : CardinalityEstimatorCRTP<SpnEstimator>
    {
        ...
        public:
            ...
            SpnDataModel(table_spn_map spns, std::size_t num_rows)
                : spns_(std::move(spns)), num_rows_(num_rows)
            {
            }
