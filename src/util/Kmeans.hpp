 ...
 */
MatrixRXf kmeans_plus_plus(const Eigen::MatrixXf &data, unsigned k);
 ...
 */
std::pair<std::vector<unsigned>, MatrixRXf> kmeans_with_centroids(const Eigen::MatrixXf &data, unsigned k);
 ...
 */
inline std::vector<unsigned> kmeans(const Eigen::MatrixXf &data, unsigned k) {
