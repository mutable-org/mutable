...
if __name__ == '__main__':
    with HyperProcess(telemetry=Telemetry.DO_NOT_SEND_USAGE_DATA_TO_TABLEAU) as hyper:
        with Connection(endpoint=hyper.endpoint, database='benchmark.hyper', create_mode=CreateMode.CREATE_AND_REPLACE) as connection:
            ...
            times = list()
            queries = [
                f'SELECT COUNT(*) FROM {table_def.table_name} WHERE a0 < -2147483647 AND a1 < -2147483647',
                f'SELECT COUNT(*) FROM {table_def.table_name} WHERE a0 < -1932735283 AND a1 < -1932735283',
                f'SELECT COUNT(*) FROM {table_def.table_name} WHERE a0 < -1717986918 AND a1 < -1717986918',
                f'SELECT COUNT(*) FROM {table_def.table_name} WHERE a0 < -1288490188 AND a1 < -1288490188',
                f'SELECT COUNT(*) FROM {table_def.table_name} WHERE a0 <  -858993459 AND a1 <  -858993459',
                f'SELECT COUNT(*) FROM {table_def.table_name} WHERE a0 <  -429496729 AND a1 <  -429496729',
                f'SELECT COUNT(*) FROM {table_def.table_name} WHERE a0 <           0 AND a1 <           0',
                f'SELECT COUNT(*) FROM {table_def.table_name} WHERE a0 <   429496729 AND a1 <   429496729',
                f'SELECT COUNT(*) FROM {table_def.table_name} WHERE a0 <   858993459 AND a1 <   858993459',
                f'SELECT COUNT(*) FROM {table_def.table_name} WHERE a0 <  1288490188 AND a1 <  1288490188',
                f'SELECT COUNT(*) FROM {table_def.table_name} WHERE a0 <  1717986918 AND a1 <  1717986918',
